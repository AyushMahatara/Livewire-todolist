<div wire:key='{{ $todo->id }}'
    ...
    <div class="flex justify-between space-x-2">
        ...
        <div class="flex">
            @if ($todo->completed)
            <input wire:click='toggleCheck({{ $todo->id }})' class="mr-3" type="checkbox" checked>
            @else
            <input wire:click='toggleCheck({{ $todo->id }})' class="mr-3" type="checkbox">
            @endif
    ...
    <div class="mt-3 text-xs text-gray-700">
        ...
        <button class="mt-3 px-4 py-2 bg-red-500 text-white font-semibold rounded hover:bg-red-600">Cancel</button>
        @endif
